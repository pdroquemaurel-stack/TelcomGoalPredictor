...
export default async function HomePage() {
  ...
  return (
    <main
      className="relative flex h-[100dvh] min-h-screen w-full items-center justify-center overflow-hidden"
      style={{
        backgroundImage: "url('/backgrounds/daily-recap-pitch.webp')",
    ...
    >
      ...
      <section className="relative z-10 w-full max-w-md space-y-4 px-4 py-6">
        <div>
